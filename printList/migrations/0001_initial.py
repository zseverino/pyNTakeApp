    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('net_ID_or_name', models.CharField(max_length=10, null=True, validators=[django.core.validators.RegexValidator('^[a-zA-Z]+$', 'Only letters in NetID/Name.')])),
                ('email', models.EmailField(max_length=254, null=True)),
                ('print_name', models.CharField(max_length=200)),
                ('usage', models.PositiveSmallIntegerField(blank=True, null=True)),
                ('file', models.FileField(upload_to=printList.models.Print.user_directory_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['stl', '3mf', 'obj'])])),
                ('printer_file', models.FileField(blank=True, null=True, upload_to=printList.models.Print.user_directory_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['gcode', 'form'])])),
                ...
                ('resolution', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, blank=True, chained_field='print_Type', chained_model_field='print_Type', null=True, on_delete=django.db.models.deletion.CASCADE, to='printList.Resolution')),
            ],
        ),
        migrations.AddField(
            model_name='infill',
